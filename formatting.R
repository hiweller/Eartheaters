setwd('/Users/hannah/Dropbox/Westneat_Lab/Eartheater Project/Data/EBL/Coordinates/')
coorddir <- dir('/Users/hannah/Dropbox/Westneat_Lab/Eartheater Project/Data/EBL/Coordinates/',
                pattern='*.csv')
...
write.csv(finalfile, '../../MorphoJ_files/07-20-2016_EBL.csv')
