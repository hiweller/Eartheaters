...
function drawEpipolarLine(){
	...
	var xy1 = moveToTarget(0,0,0,parseFloat(epipolar_intercept),photograph.w/photograph.pw,photograph.h/photograph.ph,1);
	var xy2 = moveToTarget(0,0,10000,parseFloat(epipolar_slope)*10000+parseFloat(epipolar_intercept),photograph.w/photograph.pw,photograph.h/photograph.ph,1);
...
function loadImageNames(){
	...
	if(stereo_input){
		...
		document.getElementById("prev_image_aspect").style.width = '147px';
		document.getElementById("prev_image_aspect").style.margin = '0px 5px 0px 6px';
		document.getElementById("next_image_aspect").style.width = '147px';
	}
}
...
function onWindowResize(){
	...
	document.getElementById('landmark_table_container').setAttribute('style', 'height:' + (new_tab_div_height-18) + 'px;');
	document.getElementById('curve_table_container').setAttribute('style', 'height:' + (new_tab_div_height-18) + 'px;');
